...
import com.example.kotlinproject.databinding.FragmentMapsBinding
...
//    }
    ...
    private fun getURL(location: Location, keyword: String?): String {
        val url = "maps/api/place/nearbysearch/json?location=" +
                "${location.latitude},${location.longitude}" +
                "&keyword=${keyword}&key=${API_KEY}&radius=1000&type=restaurant"
        return url
    }
